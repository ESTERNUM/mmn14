...
bool process_string_instruction(line_info line, int index, long *data_imge, long *dc) {
 ...
 */
bool process_data_instruction(line_info line, int index, long *data_imge, long *dc) {
